...
export const PopupTopLayer = /*#__PURE__*/memo(function PopupTopLayer({
   ...
   */
  const consumerInitialFocusRef = useRef(null);
  const setInitialFocusRef = useCallback(value => {
  ...
  const handleObserverClose = useCallback(() => {
    onClose === null || onClose === void 0 ? void 0 : onClose(createPopoverCloseEvent({
      reason: 'programmatic'
    }));
  }, [onClose]);
