...
export var toStatsigUser = function toStatsigUser(identifiers, customAttributes) {
  ...
  var stableId = identifiers.stableId,
    otherIdentifiers = _objectWithoutProperties(identifiers, _excluded);
  var user = {
...
export function deepAssign(target) {
  ...
  if (source === undefined || source === null) {
    return deepAssign.apply(void 0, [target].concat(_toConsumableArray(sources)));
  }
  for (var _i = 0, _Object$entries = Object.entries(source); _i < _Object$entries.length; _i++) {
    ...
    var dst = target[key];
    var srcIsObj = src && _typeof(src) === 'object' && !Array.isArray(src);
    var dstIsObj = dst && _typeof(dst) === 'object' && !Array.isArray(dst);
