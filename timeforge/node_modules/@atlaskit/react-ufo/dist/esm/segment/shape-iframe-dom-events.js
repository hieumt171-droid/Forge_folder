...
function extractPayload(data) {
  return data.payload !== null && _typeof(data.payload) === 'object' ? data.payload : {};
}
 ...
 */
export function shapePaintTimingData(data) {
 ...
 */
export function shapeLargestContentfulPaintData(data) {
  var payload = extractPayload(data);
  return {
    startTime: num(payload.startTime),
 ...
 */
export function isDomMutationsFinalBatch(data) {
  var payload = extractPayload(data);
 ...
 */
export function shapeDomMutationsData(data) {
  var payload = extractPayload(data);
  return {
