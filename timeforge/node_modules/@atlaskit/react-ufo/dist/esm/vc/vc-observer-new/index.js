...
var VCObserverNew = /*#__PURE__*/function () {
  function VCObserverNew(config) {
    ...
    this.selectorConfig = (_ref = (_getSelectorConfig = getSelectorConfig(config.selectorConfig, DEFAULT_SELECTOR_CONFIG)) !== null && _getSelectorConfig !== void 0 ? _getSelectorConfig : config.selectorConfig) !== null && _ref !== void 0 ? _ref : DEFAULT_SELECTOR_CONFIG;
        ...
        return _regeneratorRuntime.wrap(function (_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              isFy2604Enabled = isVCRevisionEnabled('fy26.04');
              _context.next = 4;
              return Promise.all([isFy2604Enabled ? calculator_fy26_04.calculate(calculatorParams) : null, isVCRevisionEnabled('next') ? calculator_next.calculate(calculatorParams) : null]);
            case 4:
              ...
              shouldIncludeRawData = includeRawData || !isFy2604Enabled || fg('platform_ufo_always_emit_raw_handler');
...
function labelStackToString(labelStack) {
  return labelStack.map(function (label) {
    return sanitizeLabelStackName(label.name);
  }).join('/');
}
