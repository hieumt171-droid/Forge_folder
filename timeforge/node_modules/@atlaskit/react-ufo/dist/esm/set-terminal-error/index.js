...
export function setTerminalError(error, additionalAttributes, labelStack) {
  ...
  if (additionalAttributes !== null && additionalAttributes !== void 0 && additionalAttributes.isClientNetworkError && !fg('platform_ufo_terminal_errors_track_client_errors')) {
