...
import { getAwaitBM3TTIList, getCapabilityRate, getConfig, getExtraInteractionRate, getFinishInteractionOnTransition, getInteractionTimeout, getPostInteractionRate, getReactHydrationStats, getSelectorConfig, shouldUseRawDataThirdPartyBehavior } from '../config';
...
export function addSegmentExtraData(interactionId, segmentId, data) {
  var interaction = interactions.get(interactionId);
  if (interaction != null) {
...
export function addIframeSegmentData(interactionId, segmentId, entry) {
  var interaction = interactions.get(interactionId);
  ...
  if (interaction != null) {
    var sanitizedData = Object.fromEntries(Object.entries(data).map(function (_ref2) {
      var _ref3 = _slicedToArray(_ref2, 2),
        key = _ref3[0],
        timingData = _ref3[1];
      return [sanitizeTimingName(key), timingData];
    }));
 ...
 */
export function addCompletedHold(interactionId, labelStack, name, start, end) {
  var interaction = interactions.get(interactionId);
  if (interaction != null) {
...
function shouldMoveHoldToExtendedBucket(interaction, hold) {
  ...
  return isExplicitlyThirdParty || interaction.end !== 0 && hold.start > interaction.end && fg('platform_ufo_metric_variants');
}
...
function moveLateActiveHoldsToExtendedBucket(interaction) {
  ...
  var holdsToMove = _toConsumableArray(interaction.holdActive.entries()).filter(function (_ref4) {
    ...
    if (shouldUseRawDataThirdParty) {
      ...
      if (noMoreActiveHolds && noMoreActive3pHolds) {
        if (!activeSubmitted) {
          ...
          if ((_getConfig4 = getConfig()) !== null && _getConfig4 !== void 0 && (_getConfig4 = _getConfig4.extraInteractionMetrics) !== null && _getConfig4 !== void 0 && _getConfig4.enabled) {
            interactionExtraMetrics.updateFinishedInteraction(interaction);
          }
          if ((_getConfig5 = getConfig()) !== null && _getConfig5 !== void 0 && (_getConfig5 = _getConfig5.extraSearchPageInteraction) !== null && _getConfig5 !== void 0 && _getConfig5.enabled && interaction.ufoName === ((_getConfig6 = getConfig()) === null || _getConfig6 === void 0 || (_getConfig6 = _getConfig6.extraSearchPageInteraction) === null || _getConfig6 === void 0 ? void 0 : _getConfig6.searchPageMetricName)) {
      ...
      if (noMoreActiveHolds && ((_interactionExtraMetr2 = interactionExtraMetrics.finishedInteraction) === null || _interactionExtraMetr2 === void 0 ? void 0 : _interactionExtraMetr2.id) !== interactionId) {
        ...
        if (!activeSubmitted) {
          ...
          if ((_getConfig7 = getConfig()) !== null && _getConfig7 !== void 0 && (_getConfig7 = _getConfig7.extraInteractionMetrics) !== null && _getConfig7 !== void 0 && _getConfig7.enabled) {
            interactionExtraMetrics.updateFinishedInteraction(interaction);
          }
          if ((_getConfig8 = getConfig()) !== null && _getConfig8 !== void 0 && (_getConfig8 = _getConfig8.extraSearchPageInteraction) !== null && _getConfig8 !== void 0 && _getConfig8.enabled && interaction.ufoName === ((_getConfig9 = getConfig()) === null || _getConfig9 === void 0 || (_getConfig9 = _getConfig9.extraSearchPageInteraction) === null || _getConfig9 === void 0 ? void 0 : _getConfig9.searchPageMetricName)) {
            onSearchPageInteractionComplete(interactionId, interaction);
          }
          activeSubmitted = true;
        }
...
export function addNewInteraction(interactionId, ufoName, type, startTime, rate, labelStack, routeName) {
  ...
  var priorAccessedFg = type === 'press' ? {} : Object.fromEntries(allFeatureFlagsAccessed);
  var metrics = {
    id: interactionId,
    start: startTime,
    end: 0,
