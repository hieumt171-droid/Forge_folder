 ...
 */
export function shapeNavigationTimingData(data) {
 ...
 */
export function shapeResourceTimingData(data) {
  ...
  var cacheable = isCacheableType(rawName, initiatorType);
  ...
  if (cacheable) {
    ...
    var transferType = calculateTransferType(rawName, initiatorType, duration, transferSize);
