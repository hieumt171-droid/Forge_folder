 ...
 */
export var LabelStackRegistry = /*#__PURE__*/function () {
  function LabelStackRegistry() {
    _classCallCheck(this, LabelStackRegistry);
    _defineProperty(this, "nodes", []);
    _defineProperty(this, "childLookupMap", new Map());
    _defineProperty(this, "terminalLookupMap", new Map());
  }
  return _createClass(LabelStackRegistry, [{
    key: "register",
    value:
    /**
...
export function resolveLabelStackFromTrie(lookupTable, labelStackRef) {
  var labels = [];
