...
export default class VCCalculator_FY26_04 extends VCCalculator_FY25_03 {
  ...
  isEntryIncluded(entry, include3p, excludeSmartAnswersInSearch) {
    ...
    const thirdPartyAttributes = [...THIRD_PARTY_BROWSER_EXTENSION_ATTRIBUTES, ...(fg('platform_ufo_exclude_dark_reader_extension') ? DARK_READER_BROWSER_EXTENSION_ATTRIBUTES : []), ...(fg('platform_ufo_exclude_fdprocessedid_attribute') ? MORE_THIRD_PARTY_EXTENSION_ATTRIBUTES : [])];
