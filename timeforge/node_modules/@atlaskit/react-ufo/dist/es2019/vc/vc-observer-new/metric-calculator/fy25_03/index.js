...
import { DARK_READER_BROWSER_EXTENSION_ATTRIBUTES, MORE_THIRD_PARTY_EXTENSION_ATTRIBUTES, KNOWN_ATTRIBUTES_THAT_DOES_NOT_CAUSE_LAYOUT_SHIFTS, NON_VISUAL_ARIA_ATTRIBUTES, THIRD_PARTY_BROWSER_EXTENSION_ATTRIBUTES } from '../utils/constants';
...
export default class VCCalculator_FY25_03 extends AbstractVCCalculatorBase {
  ...
  isEntryIncluded(entry, include3p, excludeSmartAnswersInSearch) {
    ...
    if (entry.data.type === 'mutation:attribute') {
      ...
      if (attributeName.startsWith('data-test') || NON_VISUAL_ARIA_ATTRIBUTES.includes(attributeName) || THIRD_PARTY_BROWSER_EXTENSION_ATTRIBUTES.includes(attributeName) && fg('platform_ufo_exclude_3p_extensions_from_ttvc') || DARK_READER_BROWSER_EXTENSION_ATTRIBUTES.includes(attributeName) && fg('platform_ufo_exclude_dark_reader_extension') || MORE_THIRD_PARTY_EXTENSION_ATTRIBUTES.includes(attributeName) && fg('platform_ufo_exclude_fdprocessedid_attribute')) {
        return false;
      }
      return true;
    }
