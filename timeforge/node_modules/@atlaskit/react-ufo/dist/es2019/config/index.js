 ...
 */
export function __resetFedrampOverrideCacheForTests() {
 ...
 * detection.
 */
export function isFedrampOverrideActive() {
  try {
...
const FEDRAMP_DISABLED_SELECTOR_CONFIG = Object.freeze({
  id: false,
  testId: false,
  role: false,
  className: false,
...
export function setUFOConfig(newConfig) {
  ...
  if (enabledVCRevisions) {
    ...
    ...((_enabledVCRevisions$a = enabledVCRevisions === null || enabledVCRevisions === void 0 ? void 0 : enabledVCRevisions.all) !== null && _enabledVCRevisions$a !== void 0 ? _enabledVCRevisions$a : []), ...Object.values(byExperience).flat()];
    config = {
      ...newConfig,
      vc: {
        ...newConfig.vc,
 ...
 *                       provided a value.
 */
export function getSelectorConfig(callerOverride, defaultConfig) {
  var _ref, _config, _config$vc;
  ...
  return (_ref = callerOverride !== null && callerOverride !== void 0 ? callerOverride : (_config = config) === null || _config === void 0 ? void 0 : (_config$vc = _config.vc) === null || _config$vc === void 0 ? void 0 : _config$vc.selectorConfig) !== null && _ref !== void 0 ? _ref : defaultConfig;
}
...
export function getEnabledVCRevisions(experienceKey = '') {
  try {
    ...
    if ((_config$vc2 = config.vc) !== null && _config$vc2 !== void 0 && _config$vc2.enabled) {
      var _config$vc3, _enabledVCRevisions$b;
      const {
        enabledVCRevisions
      } = (_config$vc3 = config.vc) !== null && _config$vc3 !== void 0 ? _config$vc3 : {};
      ...
      const allRevisions = enabledVCRevisions === null || enabledVCRevisions === void 0 ? void 0 : enabledVCRevisions.all;
...
export function getReactHydrationStats() {
  ...
  try {
    ...
    const stats = (_config3 = config) === null || _config3 === void 0 ? void 0 : (_config3$getReactHydr = _config3.getReactHydrationStats) === null || _config3$getReactHydr === void 0 ? void 0 : _config3$getReactHydr.call(_config3);
