...
export function addCustomTiming(interactionId, labelStack, data) {
  const interaction = interactions.get(interactionId);
  if (interaction != null) {
    const sanitizedData = Object.fromEntries(Object.entries(data).map(([key, timingData]) => [sanitizeTimingName(key), timingData]));
...
export function addHold(interactionId, labelStack, name, _experimental) {
  ...
  if (interaction != null) {
    ...
    if (shouldMoveHoldToExtendedBucket(interaction, holdActive)) {
      ensureExtendedHoldActive(interaction).set(id, {
        ...holdActive,
        start
      });
    } else {
  ...
  if (interaction != null) {
    ...
    if (currentInteraction != null && currentHold != null) {
      if (shouldMoveHoldToExtendedBucket(currentInteraction, currentHold)) {
        ensureExtendedHoldInfo(currentInteraction).push({
          ...currentHold,
          end
        });
      } else {
...
function shouldMoveHoldToExtendedBucket(interaction, hold) {
  const isExplicitlyThirdParty = hold.labelStack.some(label => 'type' in label && label.type === 'third-party');
...
function moveLateActiveHoldsToExtendedBucket(interaction) {
  ...
  const holdsToMove = [...interaction.holdActive.entries()].filter(([, hold]) => shouldMoveHoldToExtendedBucket(interaction, hold));
...
export function tryComplete(interactionId, endTime) {
  ...
  if (interaction != null) {
    ...
    const noMoreActive3pHolds = ((_interaction$hold3pAc2 = interaction.hold3pActive) === null || _interaction$hold3pAc2 === void 0 ? void 0 : _interaction$hold3pAc2.size) === 0 || interaction.hold3pActive === undefined;
    ...
    if (shouldUseRawDataThirdParty) {
      ...
      if (noMoreActiveHolds && noMoreActive3pHolds) {
        if (!activeSubmitted) {
          var _getConfig4, _getConfig4$extraInte, _getConfig5, _getConfig5$extraSear, _getConfig6, _getConfig6$extraSear;
          ...
          if ((_getConfig4 = getConfig()) !== null && _getConfig4 !== void 0 && (_getConfig4$extraInte = _getConfig4.extraInteractionMetrics) !== null && _getConfig4$extraInte !== void 0 && _getConfig4$extraInte.enabled) {
            interactionExtraMetrics.updateFinishedInteraction(interaction);
          }
          if ((_getConfig5 = getConfig()) !== null && _getConfig5 !== void 0 && (_getConfig5$extraSear = _getConfig5.extraSearchPageInteraction) !== null && _getConfig5$extraSear !== void 0 && _getConfig5$extraSear.enabled && interaction.ufoName === ((_getConfig6 = getConfig()) === null || _getConfig6 === void 0 ? void 0 : (_getConfig6$extraSear = _getConfig6.extraSearchPageInteraction) === null || _getConfig6$extraSear === void 0 ? void 0 : _getConfig6$extraSear.searchPageMetricName)) {
      ...
      if (noMoreActiveHolds && ((_interactionExtraMetr2 = interactionExtraMetrics.finishedInteraction) === null || _interactionExtraMetr2 === void 0 ? void 0 : _interactionExtraMetr2.id) !== interactionId) {
        ...
        if (!activeSubmitted) {
          var _getConfig7, _getConfig7$extraInte, _getConfig8, _getConfig8$extraSear, _getConfig9, _getConfig9$extraSear;
          finishInteraction(interactionId, interaction, endTime);
          if ((_getConfig7 = getConfig()) !== null && _getConfig7 !== void 0 && (_getConfig7$extraInte = _getConfig7.extraInteractionMetrics) !== null && _getConfig7$extraInte !== void 0 && _getConfig7$extraInte.enabled) {
            interactionExtraMetrics.updateFinishedInteraction(interaction);
          }
          if ((_getConfig8 = getConfig()) !== null && _getConfig8 !== void 0 && (_getConfig8$extraSear = _getConfig8.extraSearchPageInteraction) !== null && _getConfig8$extraSear !== void 0 && _getConfig8$extraSear.enabled && interaction.ufoName === ((_getConfig9 = getConfig()) === null || _getConfig9 === void 0 ? void 0 : (_getConfig9$extraSear = _getConfig9.extraSearchPageInteraction) === null || _getConfig9$extraSear === void 0 ? void 0 : _getConfig9$extraSear.searchPageMetricName)) {
            onSearchPageInteractionComplete(interactionId, interaction);
          }
          activeSubmitted = true;
        }
...
export function addNewInteraction(interactionId, ufoName, type, startTime, rate, labelStack, routeName, trace = null) {
  ...
  if (type === 'transition' || type === 'page_load') {
    var _getConfig0, _getConfig0$postInter, _config$extraInteract;
