...
function isGqlUrl(name) {
  try {
    ...
    return GQL_OPERATION_PARAMS.some(param => Boolean(searchParams === null || searchParams === void 0 ? void 0 : searchParams.get(param)));
  } catch {
    return false;
  }
}
