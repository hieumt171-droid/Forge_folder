...
const RESOURCE_CODE_TO_TYPE = ['script', 'link', 'fetch', 'other', 'xmlhttprequest'];
const TRANSFER_TYPE_TO_CODE = {
  network: 0,
  memory: 1,
  disk: 2
};
const TRANSFER_CODE_TO_TYPE = ['network', 'memory', 'disk'];
