...
var Observers = exports.Observers = /*#__PURE__*/function () {
  function Observers(opts) {
    ...
    var resolved = (0, _config.getSelectorConfig)(opts.selectorConfig, this.selectorConfig);
    this.selectorConfig = resolved !== null && resolved !== void 0 ? resolved : _objectSpread(_objectSpread({}, this.selectorConfig), opts.selectorConfig);
