...
var VCObserver = exports.VCObserver = /*#__PURE__*/function () {
  function VCObserver(options) {
    ...
    var LEGACY_DEFAULT_SELECTOR_CONFIG = {
      id: false,
      testId: false,
      role: false,
      className: true,
    ...
    this.observers = new _observers.Observers({
      selectorConfig: (0, _config.getSelectorConfig)(options.selectorConfig, LEGACY_DEFAULT_SELECTOR_CONFIG) || options.selectorConfig || LEGACY_DEFAULT_SELECTOR_CONFIG,
      SSRConfig: {
