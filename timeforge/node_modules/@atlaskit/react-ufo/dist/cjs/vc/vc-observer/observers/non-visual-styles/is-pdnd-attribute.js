...
exports.PDND_REGISTRATION_ATTRIBUTES = exports.DROP_TARGET_ATTRIBUTE_PREFIX = void 0;
exports.default = isPdndAttribute;
/**
 ...
 */
var PDND_REGISTRATION_ATTRIBUTES = exports.PDND_REGISTRATION_ATTRIBUTES = new Set([
...
'data-rbd-draggable-droppable-id', 'data-rbd-draggable-index', 'data-rbd-droppable-type', 'data-rbd-droppable-direction', 'data-rbd-droppable-id', 'data-rbd-droppable-context-id', 'data-rbd-style-context-id']);
var DROP_TARGET_ATTRIBUTE_PREFIX = exports.DROP_TARGET_ATTRIBUTE_PREFIX = 'data-drop-target-for-';

/**
 * Name-only match (rbd-migration attributes carry dynamic values).
 */
function isPdndAttribute(_ref) {
