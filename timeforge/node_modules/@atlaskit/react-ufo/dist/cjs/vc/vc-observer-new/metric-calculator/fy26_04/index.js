...
var VCCalculator_FY26_04 = exports.default = /*#__PURE__*/function (_VCCalculator_FY25_) {
  ...
  return (0, _createClass2.default)(VCCalculator_FY26_04, [{
    ...
    value: function isEntryIncluded(entry, include3p, excludeSmartAnswersInSearch) {
      ...
      var thirdPartyAttributes = [].concat((0, _toConsumableArray2.default)(_constants.THIRD_PARTY_BROWSER_EXTENSION_ATTRIBUTES), (0, _toConsumableArray2.default)((0, _platformFeatureFlags.fg)('platform_ufo_exclude_dark_reader_extension') ? _constants.DARK_READER_BROWSER_EXTENSION_ATTRIBUTES : []), (0, _toConsumableArray2.default)((0, _platformFeatureFlags.fg)('platform_ufo_exclude_fdprocessedid_attribute') ? _constants.MORE_THIRD_PARTY_EXTENSION_ATTRIBUTES : []));
