...
var _classifyTerminalError = require("./classify-terminal-error");
...
function setTerminalError(error, additionalAttributes, labelStack) {
  ...
  if (additionalAttributes !== null && additionalAttributes !== void 0 && additionalAttributes.isClientNetworkError && !(0, _platformFeatureFlags.fg)('platform_ufo_terminal_errors_track_client_errors')) {
  ...
  var baseErrorData = _objectSpread({
  ...
  }, (0, _platformFeatureFlags.fg)('platform_ufo_terminal_errors_track_client_errors') ? {
    errorCategory: (0, _classifyTerminalError.classifyTerminalError)(error)
  } : {});
  var errorData = _objectSpread(_objectSpread({}, baseErrorData), {}, {
