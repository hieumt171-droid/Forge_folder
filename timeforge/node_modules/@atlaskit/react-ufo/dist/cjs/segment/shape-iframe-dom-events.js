...
exports.isDomMutationsFinalBatch = isDomMutationsFinalBatch;
exports.shapeDomMutationsData = shapeDomMutationsData;
exports.shapeLargestContentfulPaintData = shapeLargestContentfulPaintData;
exports.shapeLayoutShiftData = shapeLayoutShiftData;
exports.shapePaintTimingData = shapePaintTimingData;
...
function extractPayload(data) {
  return data.payload !== null && (0, _typeof2.default)(data.payload) === 'object' ? data.payload : {};
}
 ...
 */
function shapePaintTimingData(data) {
 ...
 */
function shapeLargestContentfulPaintData(data) {
  var payload = extractPayload(data);
  return {
    startTime: num(payload.startTime),
 ...
 */
function shapeLayoutShiftData(data) {
  var payload = extractPayload(data);
  var rawSources = Array.isArray(payload.sources) ? payload.sources : [];
  var sources = rawSources.map(function (source) {
    var s = source !== null && (0, _typeof2.default)(source) === 'object' ? source : {};
    return {
      node: typeof s.node === 'string' ? s.node : 'unknown'
    };
  });
  return {
 ...
 */
function isDomMutationsFinalBatch(data) {
  var payload = extractPayload(data);
 ...
 */
function shapeDomMutationsData(data) {
  var payload = extractPayload(data);
  return {
