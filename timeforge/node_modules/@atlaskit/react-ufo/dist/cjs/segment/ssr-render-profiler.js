...
var SsrRenderProfilerInner = exports.SsrRenderProfilerInner = function SsrRenderProfilerInner(_ref2) {
  ...
  var reactProfilerId = (0, _react.useMemo)(function () {
    return labelStack.map(function (l) {
      return (0, _utils.sanitizeLabelStackName)(l.name);
    }).join('/');
  }, [labelStack]);
  checkActiveInteractionAndResetStartMarksIfSet();
  var parentSpan = (0, _react.useContext)(ParentSpanContext);
  var currentSpanState = onStartRender(reactProfilerId, (0, _utils.sanitizeLabelStackName)(labelStack[labelStack.length - 1].name), parentSpan);
