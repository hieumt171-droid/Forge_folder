...
function resolveSelectorConfig() {
  var _getSelectorConfig;
  return (_getSelectorConfig = (0, _config.getSelectorConfig)()) !== null && _getSelectorConfig !== void 0 ? _getSelectorConfig : DEFAULT_SELECTOR_CONFIG;
}
  ...
  if ((interaction === null || interaction === void 0 ? void 0 : interaction.type) === 'press') {
    ...
    if (!((_interaction$responsi = interaction.responsiveness) !== null && _interaction$responsi !== void 0 && _interaction$responsi.experimentalInputToNextPaint)) {
      ...
      if (interaction.ufoName === 'unknown') {
        ...
        interaction.unknownElementName = (0, _getUniqueElementName.default)(resolveSelectorConfig(), entry.target);
      }
    }
  }
};