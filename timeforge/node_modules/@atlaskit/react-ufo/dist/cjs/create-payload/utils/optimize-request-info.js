...
function optimizeRequestInfo(requestInfo, interactionStart, reactUFOVersion, registry) {
  var updatedRequestInfo = requestInfo.reduce(function (result, reqInfo) {
    ...
    if (labelStack && start >= interactionStart && endTime) {
      result.push({
        labelStack: (0, _utils.optimizeLabelStackWithRegistry)([].concat((0, _toConsumableArray2.default)(labelStack), [{
          name: name
