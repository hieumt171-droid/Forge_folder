...
function _createSegmentMetricsPayloads() {
  _createSegmentMetricsPayloads = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(interactionId, interaction) {
    ...
    var config, browserMetadata, cohortingCustomData, pageVisibilityAtTTAI, knownSegments, reactProfilerTimings, rate, routeName, previousInteractionName, isPreviousInteractionAborted, abortedByInteractionName, segmentsByName, _iterator, _step, _loop, _ret, payloads, _iterator2, _step2, _loop2, _ret2, _t, _t2;
    return _regenerator.default.wrap(function (_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 11:
          ...
          return _context3.delegateYield(_loop2(), "t1", 12);
        case 12:
          _ret2 = _context3.t1;
          if (!(_ret2 === 0)) {
            _context3.next = 13;
    ...
    }, _callee, null, [[2, 7, 8, 9], [10, 15, 16, 17]]);
  }));
  return _createSegmentMetricsPayloads.apply(this, arguments);
}