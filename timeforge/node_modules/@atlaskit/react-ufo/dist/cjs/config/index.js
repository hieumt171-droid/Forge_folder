...
exports.__resetFedrampOverrideCacheForTests = __resetFedrampOverrideCacheForTests;
...
exports.getSelectorConfig = getSelectorConfig;
...
exports.isFedrampOverrideActive = isFedrampOverrideActive;
 ...
 * unit tests only.
 */
var cachedIsFedrampModerate;
function detectIsFedrampModerate() {
  if (cachedIsFedrampModerate !== undefined) {
    return cachedIsFedrampModerate;
  }
  try {
    cachedIsFedrampModerate = (0, _atlassianContext.isFedrampModerate)();
  } catch (_unused) {
 ...
 */
function __resetFedrampOverrideCacheForTests() {
 ...
 * detection.
 */
function isFedrampOverrideActive() {
  try {
...
var FEDRAMP_DISABLED_SELECTOR_CONFIG = Object.freeze({
  id: false,
  testId: false,
  role: false,
  className: false,
...
function setUFOConfig(newConfig) {
  ...
  if (enabledVCRevisions) {
    ...
    var allRevisions = [].concat((0, _toConsumableArray2.default)((_enabledVCRevisions$a = enabledVCRevisions === null || enabledVCRevisions === void 0 ? void 0 : enabledVCRevisions.all) !== null && _enabledVCRevisions$a !== void 0 ? _enabledVCRevisions$a : []), (0, _toConsumableArray2.default)(Object.values(byExperience).flat()));
 ...
 *                       provided a value.
 */
function getSelectorConfig(callerOverride, defaultConfig) {
  var _ref2, _config;
  ...
  return (_ref2 = callerOverride !== null && callerOverride !== void 0 ? callerOverride : (_config = config) === null || _config === void 0 || (_config = _config.vc) === null || _config === void 0 ? void 0 : _config.selectorConfig) !== null && _ref2 !== void 0 ? _ref2 : defaultConfig;
}
...
function isUFOEnabled() {
  ...
  return ((_config2 = config) === null || _config2 === void 0 ? void 0 : _config2.enabled) !== false;
}
...
function getEnabledVCRevisions() {
  ...
  try {
    ...
    if ((_config$vc = config.vc) !== null && _config$vc !== void 0 && _config$vc.enabled) {
      ...
      var _ref3 = (_config$vc2 = config.vc) !== null && _config$vc2 !== void 0 ? _config$vc2 : {},
        enabledVCRevisions = _ref3.enabledVCRevisions;
      ...
      var allRevisions = enabledVCRevisions === null || enabledVCRevisions === void 0 ? void 0 : enabledVCRevisions.all;
      if (Array.isArray(allRevisions) && allRevisions.length === 0 && (0, _platformFeatureFlags.fg)('ufo_disable_ttvc_v4')) {
        return allRevisions;
      }
...
function getReactHydrationStats() {
  ...
  try {
    var _config3, _config3$getReactHydr;
    var stats = (_config3 = config) === null || _config3 === void 0 || (_config3$getReactHydr = _config3.getReactHydrationStats) === null || _config3$getReactHydr === void 0 ? void 0 : _config3$getReactHydr.call(_config3);
...
function getInteractionRate(name, interactionKind) {
  try {
    ...
    var _config4 = config,
      killswitch = _config4.killswitch,
      rates = _config4.rates,
      rules = _config4.rules,
      kind = _config4.kind,
      autoGeneratedRate = _config4.autoGeneratedRate;
    if (killswitch != null) {
