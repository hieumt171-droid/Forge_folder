...
export type LifecycleObservationType = 'new_interaction_started' | 'transition_started' | 'timeout_expired' | 'page_unloaded';
...
export type LastInteractionFinishInfo = Pick<InteractionMetrics, 'ufoName' | 'start' | 'end' | 'id' | 'abortReason' | 'abortedByInteractionName' | 'routeName' | 'type' | 'errors'>;
