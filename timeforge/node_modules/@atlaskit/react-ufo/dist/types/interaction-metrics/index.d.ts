import type { AbortReasonType, ApdexType, BM3Event, CustomData, CustomTiming, InteractionError, InteractionMetrics, InteractionType, LifecycleMarkType, LoadProfilerEventInfo, Mark, MarkType, PostInteractionLogOutput, ReactProfilerTiming, RequestInfo, Segment3pTimingEntry, Span, SpanType } from '../common';
...
export declare function addSegmentExtraData(interactionId: string, segmentId: string, data: Record<string, string | undefined>): void;
export declare function addIframeSegmentData(interactionId: string, segmentId: string, entry: Segment3pTimingEntry): void;
 ...
 */
export declare function addCompletedHold(interactionId: string, labelStack: LabelStack, name: string, start: number, end: number): void;
