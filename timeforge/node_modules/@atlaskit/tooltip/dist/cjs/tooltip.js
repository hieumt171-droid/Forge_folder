...
function Tooltip(_ref) {
  ...
  var tryShowTooltip = (0, _react.useCallback)(function (source) {
    ...
    var entry = {
      ...
      hide: function hide(_ref4) {
        ...
        if (isImmediate) {
          setState('hide');
        } else if ((0, _platformFeatureFlags.fg)('platform-dst-top-layer')) {
  ...
  (0, _useCloseOnEscapePress.default)({
    ...
    isDisabled: state === 'hide' || state === 'fade-out' || state === 'top-layer-exit' || (0, _platformFeatureFlags.fg)('platform-dst-top-layer')
  });
  ...
  _react.default.createElement(_react.default.Fragment, null, children(_objectSpread(_objectSpread(_objectSpread({}, tooltipTriggerProps), testId ? {
  ...
  /*#__PURE__*/
  // @ts-ignore
  _react.default.createElement(CastTargetContainer, (0, _extends2.default)({}, tooltipTriggerProps, testId ? {
  ...
  if ((0, _platformFeatureFlags.fg)('platform-dst-top-layer')) {
    ...
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, trigger, shouldRenderTooltipPopup ? /*#__PURE__*/_react.default.createElement(TopLayerTooltipPopup, {
      targetRef: targetRef,
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, trigger, shouldRenderTooltipPopup ? /*#__PURE__*/_react.default.createElement(PopperWrapper, null, /*#__PURE__*/_react.default.createElement(_popper.Popper, {
...
var tooltipAnimation = (0, _animations.slideAndFade)();
// Mouse-position tooltips follow the cursor and have no fixed direction — fade only.
var tooltipMouseAnimation = (0, _animations.fade)();
...
function TopLayerTooltipPopup(_ref8) {
  ...
  var placement = (0, _placementMap.fromLegacyPlacement)({
