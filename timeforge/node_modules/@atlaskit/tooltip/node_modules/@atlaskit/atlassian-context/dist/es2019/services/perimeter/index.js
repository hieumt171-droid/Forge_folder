...
export function isFedrampModerate() {
  if (typeof document === 'undefined') {
    var _globalThis$ssrContex3, _globalThis$ssrContex4;
    // @ts-ignore
    return (_globalThis$ssrContex3 = (_globalThis$ssrContex4 = globalThis.ssrContext) === null || _globalThis$ssrContex4 === void 0 ? void 0 : _globalThis$ssrContex4.isInFedramp) !== null && _globalThis$ssrContex3 !== void 0 ? _globalThis$ssrContex3 : false;
  }
  const atlCtxCookieValues = parseAtlCtxCookies();
  if (!atlCtxCookieValues) {
    // If the cookies are not set, the current perimeter is non-isolated commercial
...
export function isolationContextId() {
  if (typeof document === 'undefined') {
    var _globalThis$ssrContex5;
    // @ts-ignore
    return isIsolatedCloud() ? (_globalThis$ssrContex5 = globalThis.ssrContext) === null || _globalThis$ssrContex5 === void 0 ? void 0 : _globalThis$ssrContex5.icName : undefined;
  }
  const atlCtxCookieValues = parseAtlCtxCookies();
...
function cloudEnvironmentSsrLookup() {
  var _globalThis$ssrContex6, _globalThis$ssrContex7;
  // @ts-ignore
  if (((_globalThis$ssrContex6 = globalThis.ssrContext) === null || _globalThis$ssrContex6 === void 0 ? void 0 : _globalThis$ssrContex6.isInIC) === true) {
    return {
      type: 'isolated-cloud',
  ...
  // @ts-ignore
  if (((_globalThis$ssrContex7 = globalThis.ssrContext) === null || _globalThis$ssrContex7 === void 0 ? void 0 : _globalThis$ssrContex7.isInFedramp) === true) {
    return {
