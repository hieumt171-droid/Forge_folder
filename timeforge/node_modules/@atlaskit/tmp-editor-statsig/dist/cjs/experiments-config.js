...
var editorExperimentsConfig = exports.editorExperimentsConfig = {
  ...
  platform_editor_toolbar_hide_overflow_menu: (0, _experimentBuilders.createBooleanExperiment)({
    productKeys: {
  ...
  // Added 2026-05-06
  'jira-smart-replies-v2': (0, _experimentBuilders.createBooleanExperiment)({
    productKeys: {
  ...
  platform_editor_ai_replace_doc: (0, _experimentBuilders.createBooleanExperiment)({
    productKeys: {
