...
var _functionCallToVariable = exports._functionCallToVariable = function _functionCallToVariable(variableName, functionName, args, typeAnnotation) {
  if (typeAnnotation) {
    return "export const ".concat(variableName, ": ").concat(typeAnnotation, " = ").concat(functionName, "(").concat(args.join(','), ")");
  }
