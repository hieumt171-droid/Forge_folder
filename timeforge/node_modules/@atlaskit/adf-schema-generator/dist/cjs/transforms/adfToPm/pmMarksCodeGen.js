...
function pmMarksCodeGen(markResMap) {
  return (0, _codeGenHelpers._codeBlock)(_adfToPmAutogeneratedMessage.adfToPmAutogeneratedMessage, "import { createPMMarkSpecFactory, type PMMarkSpecFactoryInstance } from '../../schema/createPMSpecFactory'", (0, _codeGenHelpers._namedTypeImport)('@atlaskit/editor-prosemirror/model', 'Mark'), (0, _objectToSortedArray.objectToSortedArray)(markResMap).map(function (_ref) {
    ...
    // build markSpec
    (0, _codeGenHelpers._functionCallToVariable)(functionName, "createPMMarkSpecFactory".concat(markAttrs ? "<".concat(markName, ">") : ''), [(0, _codeGenHelpers.stringifyWithUndefined)(pmMarkSpec)], markAttrs ? "PMMarkSpecFactoryInstance<".concat(markName, ">") : 'PMMarkSpecFactoryInstance<Mark>'));
  }).join('\n\n'));
}