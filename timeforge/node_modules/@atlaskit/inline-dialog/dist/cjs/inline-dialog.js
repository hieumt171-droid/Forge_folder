...
var _inlineDialogTopLayer = _interopRequireDefault(require("./inline-dialog-top-layer"));
...
var InlineDialog = /*#__PURE__*/(0, _react.memo)(function InlineDialog(props) {
  if ((0, _platformFeatureFlags.fg)('platform-dst-top-layer')) {
    return /*#__PURE__*/_react.default.createElement(_inlineDialogTopLayer.default, props);
  }
  return /*#__PURE__*/_react.default.createElement(InlineDialogLegacy, props);
});
function InlineDialogLegacy(_ref2) {
