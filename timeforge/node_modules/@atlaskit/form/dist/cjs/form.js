...
var FormBase = function FormBase(props, ref) {
        ...
        mutators: {
          setDefaultValue: function setDefaultValue(_ref, state) {
            ...
            if (state.formState.initialValues) {
              ...
              (0, _set.default)(initialValues, name, value);
              (0, _set.default)(values, name, value);
            }
          }
        }
      });
  ...
  }, /*#__PURE__*/_react.default.createElement(_isDisabledContext.IsDisabledContext.Provider, {
    value: isDisabled
  }, childrenContent));
};
