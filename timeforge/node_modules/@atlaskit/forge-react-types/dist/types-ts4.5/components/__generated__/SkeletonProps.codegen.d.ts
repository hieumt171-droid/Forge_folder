...
export type BorderRadius = 'radius.xsmall' | 'radius.small' | 'radius.medium' | 'radius.large' | 'radius.xlarge' | 'radius.xxlarge' | 'radius.full' | 'radius.tile';
type PlatformSkeletonProps = React.ComponentProps<typeof PlatformSkeleton>;
export type SkeletonProps = Pick<PlatformSkeletonProps, 'width' | 'height' | 'isShimmering' | 'groupName' | 'testId'> & {
    /**
