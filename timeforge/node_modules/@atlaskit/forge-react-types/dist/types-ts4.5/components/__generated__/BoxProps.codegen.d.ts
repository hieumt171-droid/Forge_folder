...
declare const xcssValidator: XCSSPropsValidator<{
    textAlign: {
        allowCSS: true;
    };
    color: true;
    ...
    borderTopColor: true;
    overflow: {
        supportedValues: ("auto" | "hidden" | "scroll" | "visible")[];
    };
    overflowX: {
        supportedValues: ("auto" | "hidden" | "scroll" | "visible")[];
    };
    ...
    display: {
        supportedValues: ("block" | "inline" | "inline-block" | "none")[];
    };
    flexGrow: {
        allowCSS: true;
    };
    ...
    paddingTop: true;
    borderRadius: {
        supportedValues: ("radius.xsmall" | "radius.small" | "radius.medium" | "radius.large" | "radius.xlarge" | "radius.xxlarge" | "radius.full" | "radius.tile")[];
    };
    ...
    borderTopWidth: true;
    borderTopStyle: {
        supportedValues: ("hidden" | "none" | "dashed" | "dotted" | "solid")[];
    };
    borderBottomStyle: {
        supportedValues: ("hidden" | "none" | "dashed" | "dotted" | "solid")[];
    };
