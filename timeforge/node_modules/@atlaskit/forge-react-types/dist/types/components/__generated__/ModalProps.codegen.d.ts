...
type ModalNamedSizes = 'small' | 'medium' | 'large' | 'x-large' | 'fullscreen' | 'resizable';
export type ModalProps = Pick<PlatformModalDialogProps, 'autoFocus' | 'children' | 'onClose' | 'shouldScrollInViewport' | 'label' | 'testId'> & {
    /**
