...
export type BreadcrumbsProps = Pick<PlatformBreadcrumbsProps, 'defaultExpanded' | 'isExpanded' | 'maxItems' | 'itemsBeforeCollapse' | 'itemsAfterCollapse' | 'onExpand' | 'children' | 'label' | 'ellipsisLabel' | 'testId'>;
/**
