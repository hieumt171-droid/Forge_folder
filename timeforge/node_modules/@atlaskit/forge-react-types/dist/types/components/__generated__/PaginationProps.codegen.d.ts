...
export type PaginationProps = Pick<PlatformPaginationProps, 'pages' | 'defaultSelectedIndex' | 'selectedIndex' | 'onChange' | 'max' | 'label' | 'nextLabel' | 'previousLabel' | 'pageLabel' | 'testId'>;
/**
