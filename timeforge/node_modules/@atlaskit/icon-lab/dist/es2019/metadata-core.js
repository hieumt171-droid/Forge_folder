...
const metadata = {
  'ai-agent-add': {
    keywords: ['ai-agent-add', 'aiagentadd', 'icon', 'icon-lab', 'agent', 'ai agent', 'add', 'plus', 'ai'],
  ...
  bird: {
    ...
    categorization: 'multi-purpose',
    usage: 'A fun little bird drawn as a legacy to Jesse Bauer (a huge bird nerd) who crafted the iconography system.',
    team: 'Design System Team',
    status: 'published'
  },
  'blast-radius': {
  ...
  'cloud-fortified': {
    keywords: ['cloud-fortified', 'cloudfortified', 'icon', 'icon-lab', 'Cloud fortified', 'trust', 'program', 'security', 'badge'],
  ...
  'deployed-service': {
    keywords: ['deployed-service', 'deployedservice', 'icon', 'icon-lab', 'deployed service', 'deployment'],
  ...
  'emoji-sad': {
    keywords: ['emoji-sad', 'emojisad', 'icon', 'icon-lab', 'emoji-sad', 'emojisad', 'sad-emoji', 'sad', 'negative'],
  ...
  'file-markdown': {
    keywords: ['file-markdown', 'filemarkdown', 'icon', 'icon-lab', 'md', 'markdown', 'document', 'file', 'paper'],
  ...
  hierarchy: {
    keywords: ['hierarchy', 'icon', 'icon-lab', 'hierarchy', 'heirarchy', 'hierachy', 'relationship', 'tree'],
  ...
  'image-ratio-auto': {
    keywords: ['image-ratio-auto', 'imageratioauto', 'icon', 'icon-lab', 'automatic ratio', 'ratio', 'ratio auto'],
  ...
  'image-ratio-narrow': {
    keywords: ['image-ratio-narrow', 'imagerationarrow', 'icon', 'icon-lab', 'narrow', 'ratio narrow', 'rectangle'],
  ...
  'image-ratio-portrait': {
    keywords: ['image-ratio-portrait', 'imageratioportrait', 'icon', 'icon-lab', 'portrait', 'rectangle', 'ratio portrait'],
  ...
  'image-ratio-wide': {
    keywords: ['image-ratio-wide', 'imageratiowide', 'icon', 'icon-lab', 'wide', 'ratio wide', 'wide ratio', 'rectangle'],
  ...
  'person-assignee': {
    keywords: ['person-assignee', 'personassignee', 'icon', 'icon-lab', 'person', 'assigned to me', 'assignee'],
  ...
  'speedometer-left-down': {
    keywords: ['speedometer-left-down', 'speedometerleftdown', 'icon', 'icon-lab', 'speed', 'performance', 'dial', 'slowest', 'risk likelihood', 'low risk'],
  ...
  'speedometer-left-up': {
    keywords: ['speedometer-left-up', 'speedometerleftup', 'icon', 'icon-lab', 'speed', 'performance', 'dial', 'slow', 'risk likelihood', 'medium low risk'],
  ...
  'speedometer-right-down': {
    keywords: ['speedometer-right-down', 'speedometerrightdown', 'icon', 'icon-lab', 'speed', 'performance', 'dial', 'fastest', 'risk likelihood', 'high risk'],
  ...
  'speedometer-right-up': {
    keywords: ['speedometer-right-up', 'speedometerrightup', 'icon', 'icon-lab', 'speed', 'performance', 'dial', 'fast', 'risk likelihood', 'medium high risk'],
  ...
  'speedometer-up': {
    keywords: ['speedometer-up', 'speedometerup', 'icon', 'icon-lab', 'speed', 'performance', 'dial', 'risk likelihood', 'medium risk'],
  ...
  'text-normal': {
    keywords: ['text-normal', 'textnormal', 'icon', 'icon-lab', 'text style', 'text regular', 'text normal', 'paragraph', 'body'],
  ...
  'video-timeline-clip-insert-end': {
    keywords: ['video-timeline-clip-insert-end', 'videotimelineclipinsertend', 'icon', 'icon-lab', 'video', 'clip', 'timeline', 'end'],
  ...
  'video-timeline-clip-insert-playhead': {
    keywords: ['video-timeline-clip-insert-playhead', 'videotimelineclipinsertplayhead', 'icon', 'icon-lab', 'video', 'clip', 'timeline', 'playhead', 'current position'],
  ...
  'video-timeline-clip-insert-start': {
    keywords: ['video-timeline-clip-insert-start', 'videotimelineclipinsertstart', 'icon', 'icon-lab', 'video', 'clip', 'timeline', 'start', 'beginning'],
  ...
  'view-split': {
    keywords: ['view-split', 'viewsplit', 'icon', 'icon-lab', '2 col', 'two columns', 'split view', 'side-by-side', 'layout'],
