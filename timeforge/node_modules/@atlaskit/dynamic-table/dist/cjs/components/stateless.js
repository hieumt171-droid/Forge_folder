...
var _assertIsSortable = require("../internal/assert-is-sortable");
var _getPageRows = require("../internal/get-page-rows");
var _validateSortKey = require("../internal/validate-sort-key");
var _caption = require("../styled/caption");
var _emptyViewContainer = require("../styled/empty-view-container");
var _emptyViewWithFixedHeight = require("../styled/empty-view-with-fixed-height");
var _paginationWrapper = require("../styled/pagination-wrapper");
var _table = require("../styled/table");
...
var DynamicTable = function DynamicTable(_ref) {
  ...
  (0, _react.useEffect)(function () {
    (0, _validateSortKey.validateSortKey)(sortKey, head);
    (0, _assertIsSortable.assertIsSortable)(head);
  }, [sortKey, head]);
  ...
  var getSpinnerSize = function getSpinnerSize() {
    ...
    return (0, _getPageRows.getPageRows)(rows || [], page, rowsPerPage).length > 2 ? 'large' : 'small';
  };
  var renderEmptyBody = function renderEmptyBody() {
    if (isLoading) {
      return /*#__PURE__*/_react.default.createElement(_emptyViewWithFixedHeight.EmptyViewWithFixedHeight, {
        testId: testId
      });
    }
    return emptyView && /*#__PURE__*/_react.default.createElement(_emptyViewContainer.EmptyViewContainer, {
      testId: testId
    }, emptyView);
  };
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_loadingContainerAdvanced.default, {
    ...
    testId: testId,
    isLoading: isLoading
  }, !!caption && /*#__PURE__*/_react.default.createElement(_caption.Caption, null, caption), head && /*#__PURE__*/_react.default.createElement(_tableHead.default, {
    head: head,
  ...
  _react.default.createElement(_paginationWrapper.PaginationWrapper, {
    testId: testId
