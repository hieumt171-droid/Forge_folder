const elementCaches = new WeakMap();
...
function cacheResolvedLength({
  ...
  const cacheForElement = (_elementCaches$get = elementCaches.get(element)) !== null && _elementCaches$get !== void 0 ? _elementCaches$get : new Map();
...
export function resolveCssLengthToPixels({
  ...
  const cached = getCachedResolvedLength({
    element: container,
    value
  });
  if (cached !== null) {
