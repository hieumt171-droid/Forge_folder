...
export const Popover = /*#__PURE__*/forwardRef(function Popover({
  ...
  useLayoutEffect(() => {
    ...
    const props = preset.getProperties({
      placement
    });
