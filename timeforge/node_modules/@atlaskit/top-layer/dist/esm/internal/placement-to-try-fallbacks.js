 ...
 */
export function placementToTryFallbacks(_ref) {
  ...
  var sameEdge = "".concat(axis, "-").concat(edge);
  var oppositeEdge = "".concat(axis, "-").concat(flippedEdge);
  var flipKeyword = axis === 'block' ? 'flip-block' : 'flip-inline';
  var flipCrossKeyword = axis === 'block' ? 'flip-inline' : 'flip-block';
  ...
  function shifts(baseAlign, edgeKey) {
    if (baseAlign === 'center') {
      return ["".concat(edgeKey, " span-").concat(crossAxis, "-end"), "".concat(edgeKey, " span-").concat(crossAxis, "-start")];
    }
    var near = baseAlign === 'start' ? 'end' : 'start';
    var far = baseAlign === 'start' ? 'start' : 'end';
  ...
  if (align !== 'center') {
    ...
    return [].concat(_toConsumableArray(shifts(align, sameEdge)), [flipKeyword, "".concat(flipKeyword, " ").concat(flipCrossKeyword)], _toConsumableArray(shifts(align, oppositeEdge))).join(', ');
  }
  ...
  return [].concat(_toConsumableArray(shifts('center', sameEdge)), [flipKeyword], _toConsumableArray(shifts('center', oppositeEdge))).join(', ');
}