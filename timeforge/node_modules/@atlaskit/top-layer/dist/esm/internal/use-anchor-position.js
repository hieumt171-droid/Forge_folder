...
var NoopResizeObserver = /*#__PURE__*/function () {
  function NoopResizeObserver() {
    _classCallCheck(this, NoopResizeObserver);
  }
  return _createClass(NoopResizeObserver, [{
    key: "observe",
 ...
 */
var supportsAnchorPositioning = once(function () {
...
export function useAnchorPosition(_ref3) {
  ...
  useLayoutEffect(function () {
    ...
    if (supportsAnchorPositioning() && !shouldForceFallback) {
      ...
      var _undoPositioning = combine(setStyle({
        element: popover,
    ...
    var cleanupBaseStyles = setStyle({
      element: popover,
      styles: [{
        property: 'margin',
        value: '0'
    ...
    function update() {
      ...
      var gapPx = resolveCssLengthToPixels({
        value: gapCssValue,
        container: popover
      });
      var crossAxisShiftPx = resolveCssLengthToPixels({
        value: crossAxisShiftCssValue,
        container: popover
      });
      var _computeFallbackPosit = computeFallbackPosition({
    ...
    var scheduledUpdate = rafSchedule(update);
    ...
    var undoPositioning = combine(cleanupBaseStyles,
