...
export function useAnimatedVisibility(_ref2) {
  ...
  var onEnterFinishRef = useRef(onEnterFinish);
  onEnterFinishRef.current = onEnterFinish;
  var onExitFinishRef = useRef(onExitFinish);
  ...
  useEffect(function () {
    ...
    return runOnTransitionEndOrTimeout({
      element: element,
      safetyNetMs: ((_preset$enterDuration = preset === null || preset === void 0 ? void 0 : preset.enterDurationMs) !== null && _preset$enterDuration !== void 0 ? _preset$enterDuration : 0) + 50,
  ...
  }, [phase, preset === null || preset === void 0 ? void 0 : preset.enterDurationMs, elementRef]);
  ...
  var prevPhaseForEntryRef = useRef('closed');
  useEffect(function () {
  ...
  useEffect(function () {
    ...
    return runOnTransitionEndOrTimeout({
      element: element,
      safetyNetMs: ((_preset$exitDurationM = preset === null || preset === void 0 ? void 0 : preset.exitDurationMs) !== null && _preset$exitDurationM !== void 0 ? _preset$exitDurationM : 0) + 50,
      onSettled: function onSettled() {
  ...
  }, [phase, willAnimate, preset === null || preset === void 0 ? void 0 : preset.exitDurationMs, elementRef]);
  ...
  var prevPhaseForExitRef = useRef('closed');
  useEffect(function () {
