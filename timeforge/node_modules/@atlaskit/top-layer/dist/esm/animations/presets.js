...
export function popupMotion() {
  return {
    ...
    getProperties: function getProperties(_ref2) {
      ...
      return getPopupMotionProperties({
        placement: placement
      });
    }
  };
...
function getSlideAndFadeProperties(_ref3) {
  var placement = _ref3.placement,
    distance = _ref3.distance;
  var pos = "".concat(distance, "px");
  var neg = "-".concat(distance, "px");
  var _getPlacement2 = getPlacement({
      placement: placement
    }),
    axis = _getPlacement2.axis,
    edge = _getPlacement2.edge;
  if (axis === 'block' && edge === 'start') {
    return {
      '--ds-popover-tx': '0',
      '--ds-popover-ty': pos
...
export function slideAndFade(options) {
  ...
  var distance = (_options$distance = options === null || options === void 0 ? void 0 : options.distance) !== null && _options$distance !== void 0 ? _options$distance : 4;
  return {
    name: 'slide-and-fade',
    css: SLIDE_AND_FADE_CSS,
    getProperties: function getProperties(_ref4) {
      var placement = _ref4.placement;
      return getSlideAndFadeProperties({
        placement: placement,
        distance: distance
      });
    },
...
export function dialogSlideUpAndFade(options) {
  ...
  var distance = (_options$distance2 = options === null || options === void 0 ? void 0 : options.distance) !== null && _options$distance2 !== void 0 ? _options$distance2 : 12;

  // Bare preset name; `Dialog` prefixes it via `data-ds-dialog-{name}`.
  return {
    name: distance === 12 ? 'slide-up-and-fade' : "slide-up-and-fade-".concat(distance),
    css: distance === 12 ? DIALOG_SLIDE_UP_AND_FADE_CSS : DIALOG_SLIDE_UP_AND_FADE_CSS.replace(/12px/g, "".concat(distance, "px")),
    enterDurationMs: 350,
    exitDurationMs: 175
  };
}
