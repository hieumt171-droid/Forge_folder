...
var _usePresetStyles = require("./use-preset-styles");
/**
...
function useAnimatedVisibility(_ref2) {
  ...
  var preset = (0, _usePresetStyles.usePresetStyles)({
    preset: animate
  });

  // False when there is no preset or `prefers-reduced-motion` is set.
  var willAnimate = Boolean(animate) && !(0, _reducedMotion.prefersReducedMotion)();
