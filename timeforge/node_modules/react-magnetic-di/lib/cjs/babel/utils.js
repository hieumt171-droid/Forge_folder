...
var hasDisableDi = function hasDisableDi(diRef) {
  var _diRef$parentPath$nod;
  return (diRef === null || diRef === void 0 || (_diRef$parentPath$nod = diRef.parentPath.node) === null || _diRef$parentPath$nod === void 0 || (_diRef$parentPath$nod = _diRef$parentPath$nod.arguments) === null || _diRef$parentPath$nod === void 0 || (_diRef$parentPath$nod = _diRef$parentPath$nod[0]) === null || _diRef$parentPath$nod === void 0 ? void 0 : _diRef$parentPath$nod.value) === false;
};
module.exports = {
  assert: assert,
