...
const hasDisableDi = diRef => {
  ...
  return (diRef == null || (_diRef$parentPath$nod = diRef.parentPath.node) == null || (_diRef$parentPath$nod = _diRef$parentPath$nod.arguments) == null || (_diRef$parentPath$nod = _diRef$parentPath$nod[0]) == null ? void 0 : _diRef$parentPath$nod.value) === false;
};
module.exports = {
  assert,
  createNamedImport,
