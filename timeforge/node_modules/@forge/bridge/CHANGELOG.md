...
- 7a300a9: Address vuln
- 951fcca: Replace `uuid` dependency with native `crypto.randomUUID` in adf-renderer
...
- feeb0ab: fix: correct typing for callback parameters in subscribe and subscribeGlobal functions
